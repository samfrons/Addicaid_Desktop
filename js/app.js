...
//            ,'leaflet-directive'
    ...
    .config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        $routeProvider
            ...
            .when('/music', { templateUrl: 'views/music.html', controller: HomeCtrl })
            .when('/news', { templateUrl: 'views/news.html', controller: NewsCtrl })
            .when('/video', { templateUrl: 'views/video.html', controller: VideoCtrl })
            .when('/reading', { templateUrl: 'views/reading.html', controller: ReadingCtrl })
            .when('/phelp', { templateUrl: 'views/phelp.html', controller: PHelpCtrl })
            .when('/dailydose', { templateUrl: 'views/dailydose.html', controller: DailyDoseCtrl })
            .when('/buddypod', { templateUrl: 'views/buddypod.html', controller: BuddyPodCtrl })
            ...
            .when('/events', { templateUrl: 'views/events.html', controller: EventsCtrl })
            .when('/sossignal', { templateUrl: 'views/sossignal.html', controller: SOSSignalCtrl })
            .when('/rewards', { templateUrl: 'views/rewards.html', controller: RewardsCtrl })
